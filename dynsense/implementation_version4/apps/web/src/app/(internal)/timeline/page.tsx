...
// FR-160: AI-annotated Gantt-style timeline page
...
export default function TimelinePage() {
  ...
  const { sortedTasks, timelineStart, timelineEnd, totalDays, weekMarkers } = useMemo(() => {
    const now = new Date();
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-lg font-bold">AI-Annotated Timeline</h1>
        <p className="text-xs text-gray-500 mt-1">Gantt-style task timeline with risk annotations</p>
      </div>
        ...
        <div className="bg-white rounded-lg border overflow-hidden">
          ...
          <div className="relative">
            ...
            {sortedTasks.map((task) => {
              ...
              // Estimate start as 5 days before due (or creation date)
              ...
              const barWidth = Math.max(barRight - barLeft, 2); // Min 2% width
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 relative h-full">
                    {dueDate && (
                      <div
                        className={`absolute top-2 h-6 rounded ${statusBarColor[task.status] ?? "bg-gray-400"} opacity-80 flex items-center px-1.5 group`}
                        style={{
