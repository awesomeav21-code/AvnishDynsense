...
export default function ProjectDetailPage() {
  ...
  const handleCreateTask = useCallback(async () => {
    if (!newTitle.trim() || !newDescription.trim() || !newPhaseId || !newAssigneeId || !newReportedBy || !newStartDate || !newDueDate || !newEstimatedEffort || !newComment.trim() || selectedTagIds.size === 0) return;
    setCreating(true);
    try {
          ...
          <div className="bg-white rounded-lg border p-4 mb-4 space-y-4">
            ...
            <div className="flex justify-end pt-1">
              ...
              <button
                ...
                disabled={creating || !newTitle.trim() || !newDescription.trim() || !newPhaseId || !newAssigneeId || !newReportedBy || !newStartDate || !newDueDate || !newEstimatedEffort || !newComment.trim() || selectedTagIds.size === 0}
